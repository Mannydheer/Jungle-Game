...
const LionBoss = ({ allowFire, bananaMovement, setbananaMovement }) => {
    ...
    console.log(bananaMovement, 'BANANA')
    ...
    return (
        <React.Fragment>
            ...
            <div style={{ position: 'absolute', left: `${Lion.randomLeft}px`, top: `${Lion.randomTop}px`, }}>
                <div style={{ width: `${Lion.hp}px`, height: '10px', backgroundColor }}></div>
            </div>
